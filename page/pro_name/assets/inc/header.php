...
<head>
    ...
    <title>Template-guld-php</title>
    <link rel="stylesheet" href="/<?php echo DIRNAME; ?>/assets/css/lib/bootstrap.min.css">
    <link rel="stylesheet" href="/<?php echo DIRNAME; ?>/assets/css/lib/animate.min.css">
  	...
  	<script type="text/javascript" src="/<?php echo DIRNAME; ?>/assets/js/lib/jquery.min.js"></script>
</head>
<body>
	<header>
        <div class="header-menu">
            <div class="menu">
                <h1 class="logo"> <a href="/<?php echo DIRNAME; ?>">
                ...
                <ul>
                    <li>
                        <a href="/<?php echo DIRNAME; ?>/about/" class="">サービスについて</a> 
                        <i class="d-none"></i>
                    </li> <!-- end sub1 -->
                    <li>
                        <a href="/<?php echo DIRNAME; ?>/sticker/" class="">ステッカーを探す</a>
                        <i class="d-none"></i>
                    </li><!-- end sub2 -->
                    <li>
                        <a href="/<?php echo DIRNAME; ?>/guide/">ご利用ガイド</a><i class="d-none"> </i>
                    </li><!-- end sub3 -->
                    <li>
                        <a href="/<?php echo DIRNAME; ?>/faq/">よくあるご質問</a>
                        <i class="d-none"></i>
                    </li><!-- end sub4 -->
                    <li class="js-sub-menu">
                        <a href="javascript:void(0)">広告出稿のご案内</a>
                        <i class="d-none"></i>
                        <div class="sub-menu">
                            <ul>
                                <li>
                                    <div class="submenu-info">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="/<?php echo DIRNAME; ?>/about">サービスについて</a>
                                            ...
                                            <li>
                                                <a href="/<?php echo DIRNAME; ?>/guide">お申し込み方法</a>
                                                <span><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><defs><style>.a{fill:#dc000c;}.b{fill:#fff;}</style></defs><g transform="translate(-386 -297)"><circle class="a" cx="9.5" cy="9.5" r="9.5" transform="translate(386 297)"/><path class="b" d="M932.82,244.681c1.294.689,1.294,1.817,0,2.506l-3.467,1.847c-1.294.689-2.353.134-2.353-1.234v-3.73c0-1.368,1.059-1.923,2.353-1.234Z" transform="translate(-534.395 60.204)"/></g></svg></span>
                                            </li>
                                            <li>
                                                <a href="/<?php echo DIRNAME; ?>/stecker">ステッカーの仕様</a>
                                                <span><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><defs><style>.a{fill:#dc000c;}.b{fill:#fff;}</style></defs><g transform="translate(-386 -297)"><circle class="a" cx="9.5" cy="9.5" r="9.5" transform="translate(386 297)"/><path class="b" d="M932.82,244.681c1.294.689,1.294,1.817,0,2.506l-3.467,1.847c-1.294.689-2.353.134-2.353-1.234v-3.73c0-1.368,1.059-1.923,2.353-1.234Z" transform="translate(-534.395 60.204)"/></g></svg></span>
                                            </li>
                                            <li>
                                                <a href="/<?php echo DIRNAME; ?>/ads">広告のお申込み</a>
                                                <span><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><defs><style>.a{fill:#dc000c;}.b{fill:#fff;}</style></defs><g transform="translate(-386 -297)"><circle class="a" cx="9.5" cy="9.5" r="9.5" transform="translate(386 297)"/><path class="b" d="M932.82,244.681c1.294.689,1.294,1.817,0,2.506l-3.467,1.847c-1.294.689-2.353.134-2.353-1.234v-3.73c0-1.368,1.059-1.923,2.353-1.234Z" transform="translate(-534.395 60.204)"/></g></svg></span>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <li class="pc-contact">
                        <a href="/<?php echo DIRNAME; ?>/contact/" class="contact"><span><img src="/<?php echo DIRNAME; ?>/assets/images/top/mail.svg" alt=""></span>お問い合わせ</a> <i></i>
                    </li><!-- end sub6 -->
                    <li>
                        <a href="/<?php echo DIRNAME; ?>/login/" class="login"><span><img src="/<?php echo DIRNAME; ?>/assets/images/top/user.svg" alt=""></span>ログイン</a>
                    </li><!-- end sub7 -->
                </ul>
                <ul class="api d-none">
                    <li><a href=""><img src="/<?php echo DIRNAME; ?>/assets/images/top/in.svg" alt=""></a></li>
                    <li><a href=""><img src="/<?php echo DIRNAME; ?>/assets/images/top/tw.svg" alt=""></a></li>
                    <li><a href=""><img src="/<?php echo DIRNAME; ?>/assets/images/top/fa.svg" alt=""></a></li>
                </ul>
                <div class="sp-contact">
                    <a href="/<?php echo DIRNAME; ?>/contact/" class="contact"><span><img src="/<?php echo DIRNAME; ?>/assets/images/top/mail.svg" alt=""></span>お問い合わせ</a>
                </div><!-- end sub6 -->
            </div>
            <div class="bar d-none"><a href="javascript:void(0)"> <!-- button-icon-sp -->
